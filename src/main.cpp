...
int64_t GetBlockValue(int nHeight)
{
    ...
    /* block rewards. */
         ...
         if (nHeight >=       1 && nHeight <=       1) {nSubsidy =  990000.00 * COIN;} //generate the coins necessary for swap
    else if (nHeight >=       2 && nHeight <=     300) {nSubsidy =       0.20 * COIN;}
    else if (nHeight >=     301 && nHeight <=     400) {nSubsidy =       0.10 * COIN;}
    else if (nHeight >=     401 && nHeight <=   10000) {nSubsidy =       0.20 * COIN;}
    else if (nHeight >=   10001 && nHeight <=   43200) {nSubsidy =       1.00 * COIN;}
    else if (nHeight >=   43201 && nHeight <=   86400) {nSubsidy =       1.50 * COIN;}
    else if (nHeight >=   86401 && nHeight <=  172800) {nSubsidy =       2.00 * COIN;}
    else if (nHeight >=  172801 && nHeight <=  259200) {nSubsidy =       2.50 * COIN;}
    else if (nHeight >=  259201 && nHeight <=  345600) {nSubsidy =       3.00 * COIN;}
    else if (nHeight >=  345601 && nHeight <=  432000) {nSubsidy =       3.50 * COIN;}
    else if (nHeight >=  432001 && nHeight <=  561600) {nSubsidy =       4.00 * COIN;}
    else if (nHeight >=  561601 && nHeight <=  691200) {nSubsidy =       4.50 * COIN;}
    else if (nHeight >=  691201 && nHeight <=  820800) {nSubsidy =       5.00 * COIN;}
    else if (nHeight >=  820801 && nHeight <=  950400) {nSubsidy =       5.50 * COIN;}
    else if (nHeight >=  950401 && nHeight <= 1209600) {nSubsidy =       6.00 * COIN;}
    else if (nHeight >= 1209601 && nHeight <= 1468800) {nSubsidy =       5.50 * COIN;}
    else if (nHeight >= 1468801 && nHeight <= 1728000) {nSubsidy =       5.00 * COIN;}
    else if (nHeight >= 1728001 && nHeight <= 1987200) {nSubsidy =       4.50 * COIN;}
    else if (nHeight >= 1987201 && nHeight <= 2246400) {nSubsidy =       4.00 * COIN;}
    else if (nHeight >= 2246401 && nHeight <= 2505600) {nSubsidy =       3.50 * COIN;}
    else if (nHeight >= 2505601 && nHeight <= 2764800) {nSubsidy =       3.00 * COIN;}
    else if (nHeight >= 2764801 && nHeight <= 3024000) {nSubsidy =       2.50 * COIN;}
    else if (nHeight >= 3024001 && nHeight <= 3542400) {nSubsidy =       2.25 * COIN;}
    else if (nHeight >= 3542401 && nHeight <= 4060800) {nSubsidy =       2.00 * COIN;}
    else if (nHeight >= 4060801 && nHeight <= 4579200) {nSubsidy =       1.75 * COIN;}
    else if (nHeight >= 4579201 )                      {nSubsidy =       1.50 * COIN;}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    else if (nHeight >=     201 && nHeight <=  100000)  {nSubsidy = blockValue * 0.90;}
    else if (nHeight >=  100001 && nHeight <=  200000)  {nSubsidy = blockValue * 0.85;}
    else if (nHeight >=  200001 && nHeight <=  300000)  {nSubsidy = blockValue * 0.80;}
    else if (nHeight >=  300001 && nHeight <=  400000)  {nSubsidy = blockValue * 0.75;}
    else if (nHeight >=  400001 )                       {nSubsidy = blockValue * 0.70;}
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DEXTRO: We use certain sporks during IBD, so check to see if they are
        ...
        vector<CInv> vInvWait;
        {
            ...
            BOOST_FOREACH (const CInv& inv, pto->vInventoryToSend) {
                ...
                if (inv.type == MSG_TX && !fSendTrickle) {
                    // 1/4 of tx invs dxo to all immediately
                    static uint256 hashSalt;
                    if (hashSalt == 0)
                        hashSalt = GetRandHash();
