...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"dextro", "listmasternodes", &listmasternodes, true, true, false},
        {"dextro", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dextro", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dextro", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dextro", "masternodedebug", &masternodedebug, true, true, false},
        {"dextro", "startmasternode", &startmasternode, true, true, false},
        {"dextro", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dextro", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dextro", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dextro", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dextro", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dextro", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dextro", "mnbudget", &mnbudget, true, true, false},
        {"dextro", "preparebudget", &preparebudget, true, true, false},
        {"dextro", "submitbudget", &submitbudget, true, true, false},
        {"dextro", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dextro", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dextro", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dextro", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dextro", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dextro", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dextro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dextro", "checkbudgets", &checkbudgets, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39721/\n";
}
