...
// Repair parameters
const QString DEXTROWALLET("-dextrowallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_dextrowallet, SIGNAL(clicked()), this, SLOT(walletDextro()));
...
/** Restart wallet with "-dextrowallet" */
void RPCConsole::walletDextro()
{
    buildParameterlist(DEXTROWALLET);
}
