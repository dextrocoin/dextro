...
#   c) node1 mines 32 blocks, so now node 0 has 500000DXO, node 1 has 4250DXO, node2 has none.
#   d) node0 sends 601 DXO to node2, in two transactions (301 DXO, then 300 DXO).
