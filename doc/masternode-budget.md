...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _5000_ DXO, _12_ times over the course of a year totaling _60000_ DXO.
...
When block `1000000` is reached you'll receive a payment for `5000` DXO.
