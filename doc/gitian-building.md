...
```bash
    ...
    From https://github.com/dextrocoin/Dextro
...
For example:
```bash
URL=https://github.com/konez2k/dextro.git
...
[dextro/gitian.sigs](https://github.com/dextrocoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
