...
This mechanism has been integrated into Bitcore-Node-Dextro which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dextrocoin/insight-api-dextro#web-socket-api](https://github.com/dextrocoin/insight-api-dextro#web-socket-api)
* API: [https://github.com/dextrocoin/insight-api-dextro#swifttx-transactions](https://github.com/dextrocoin/insight-api-dextro#swifttx-transactions)
...
By default, the Dextro Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dextro Core daemon:
